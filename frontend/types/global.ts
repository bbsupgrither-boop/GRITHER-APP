// Р“Р»РѕР±Р°Р»СЊРЅС‹Рµ С‚РёРїС‹ РґР»СЏ РїСЂРёР»РѕР¶РµРЅРёСЏ GRITHER
...
// РџРµСЂСЃРѕРЅР°Р»СЊРЅС‹Р№ Р±Р°С‚С‚Р» РјРµР¶РґСѓ РґРІСѓРјСЏ РїРѕР»СЊР·РѕРІР°С‚РµР»СЏРјРё
...
export interface LeaderboardEntry {
  rank: number;
  user: User;
  change: number; // РёР·РјРµРЅРµРЅРёРµ РїРѕР·РёС†РёРё СЃ РїСЂРѕС€Р»РѕР№ РЅРµРґРµР»Рё
  score?: number; // С‚РµРєСѓС‰РёР№ СЃС‡С‘С‚/СЂРµР№С‚РёРЅРі
}
