    ...
    >
      ...
      <div className="max-w-md mx-auto px-4 pb-32" style={{ marginTop: '0px' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          {/* Achievement Block - Р”РѕСЃС‚РёР¶РµРЅРёСЏ РІ РїСЂРѕС†РµСЃСЃРµ */}
          ...
          {/* Battle Card Рё Leaderboard - СЂСЏРґРѕРј РїРѕ РіРѕСЂРёР·РѕРЅС‚Р°Р»Рё */}
          ...
          {/* Achievement Rewards - РџРѕР»СѓС‡РµРЅРЅС‹Рµ Р°С‡РёРІРєРё */}
