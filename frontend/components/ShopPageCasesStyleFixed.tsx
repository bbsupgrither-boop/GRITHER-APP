      ...
      {shopItems.length === 0 ? (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 max-w-lg mx-auto">
          {shopItems.map((item) => {
            ...
            // Р В¤Р С•РЎР‚Р СР В°РЎвЂљР С‘РЎР‚РЎС“Р ВµР С РЎвЂ Р ВµР Р…РЎС“ Р В±Р ВµР В· Р Т‘Р ВµР В»Р ВµР Р…Р С‘РЎРЏ Р Р…Р В° 1000
            ...
            return (
              ...
              >
                <div className="flex flex-col items-center text-center space-y-3">
                  {/* Р вЂР С•Р В»РЎРЉРЎв‚¬Р С•Р Вµ Р С‘Р В·Р С•Р В±РЎР‚Р В°Р В¶Р ВµР Р…Р С‘Р Вµ РЎвЂљР С•Р Р†Р В°РЎР‚Р В° РЎРѓ Р Р…Р ВµР С•Р Р…Р С•Р Р†РЎвЂ№Р С РЎРЊРЎвЂћРЎвЂћР ВµР С”РЎвЂљР С•Р С */}
                  <div 
                  ...
                  {/* Р В¦Р ВµР Р…Р В° РЎРѓ Р СР С•Р Р…Р ВµРЎвЂљР С”Р С•Р в„– */}
                  <div 
