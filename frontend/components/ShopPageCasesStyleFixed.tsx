      ...
      {shopItems.length === 0 ? (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 max-w-lg mx-auto">
          {shopItems.map((item) => {
            ...
            // Р¤РѕСЂРјР°С‚РёСЂСѓРµРј С†РµРЅСѓ Р±РµР· РґРµР»РµРЅРёСЏ РЅР° 1000
            ...
            return (
              ...
              >
                <div className="flex flex-col items-center text-center space-y-3">
                  {/* Р‘РѕР»СЊС€РѕРµ РёР·РѕР±СЂР°Р¶РµРЅРёРµ С‚РѕРІР°СЂР° СЃ РЅРµРѕРЅРѕРІС‹Рј СЌС„С„РµРєС‚РѕРј */}
                  <div 
