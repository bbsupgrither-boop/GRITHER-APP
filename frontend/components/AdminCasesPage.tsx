            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-4 text-xs text-muted-foreground">
                  <span>Р В¦РїС—Р…РїС—Р…Р Р…Р Р…Р С•РЎРѓРЎвЂљРЎРЉ: {prize.value}</span>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <ImageUploader
            ...
            placeholder="СЂСџвЂњВ¦ Р С‘Р В»Р С‘ URL Р С‘Р В·Р С•Р В±РЎР‚Р В°Р В¶Р ВµР Р…Р С‘РЎРЏ (https://...) Р С‘Р В»Р С‘ Р Р†РЎРѓРЎвЂљР В°Р Р†РЎРЉРЎвЂљР Вµ base64"
        ...
        {/* Р РЋР ВµР С”РЎвЂ Р С‘РЎРЏ Р Р…Р ВµР С•Р Р…Р С•Р Р†Р С•Р в„– Р С•Р В±Р Р†Р С•Р Т‘Р С”Р С‘ */}
        <div className="border-t border-border pt-4 space-y-4">
          <h4 className="font-medium text-sm" 
              style={{ color: theme === 'dark' ? '#E8ECF2' : '#0F172A' }}>
            РІСљРЃ Р СњР ВµР С•Р Р…Р С•Р Р†Р В°РЎРЏ Р С•Р В±Р Р†Р С•Р Т‘Р С”Р В°
          </h4>
          
          <div>
            <label className="block text-sm font-medium mb-2">Р В¦Р Р†Р ВµРЎвЂљ РЎРѓР Р†Р ВµРЎвЂЎР ВµР Р…Р С‘РЎРЏ</label>
            <div className="flex items-center gap-3">
              ...
              >
                Р С™Р В°Р С” Р С•РЎРѓР Р…Р С•Р Р†Р Р…Р С•Р в„–
              </button>
            </div>
          </div>

          <div>
            <label className="block text-sm font-medium mb-2">Р ВР Р…РЎвЂљР ВµР Р…РЎРѓР С‘Р Р†Р Р…Р С•РЎРѓРЎвЂљРЎРЉ РЎРѓР Р†Р ВµРЎвЂЎР ВµР Р…Р С‘РЎРЏ</label>
            <select
              value={caseForm.glowIntensity}
              onChange={(e) => setCaseForm(prev => ({ ...prev, glowIntensity: e.target.value as 'low' | 'medium' | 'high' }))}
              className="w-full px-3 py-2 bg-input-background border border-border rounded-lg"
            >
              <option value="low">Р РЋР В»Р В°Р В±Р С•Р Вµ (Low)</option>
              <option value="medium">Р РЋРЎР‚Р ВµР Т‘Р Р…Р ВµР Вµ (Medium)</option>
              <option value="high">Р Р‡РЎР‚Р С”Р С•Р Вµ (High)</option>
            </select>
          </div>

          {/* Р СџРЎР‚Р ВµР Р†РЎРЉРЎР‹ Р Р…Р ВµР С•Р Р…Р С•Р Р†Р С•Р С–Р С• РЎРѓР Р†Р ВµРЎвЂЎР ВµР Р…Р С‘РЎРЏ */}
          <div className="p-4 bg-surface-2 rounded-lg">
            <p className="text-xs text-muted-foreground mb-2">Р СџРЎР‚Р ВµР Р†РЎРЉРЎР‹ РЎРЊРЎвЂћРЎвЂћР ВµР С”РЎвЂљР В°:</p>
            <div 
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <ImageUploader
            ...
            placeholder="СЂСџР‹Рѓ Р С‘Р В»Р С‘ URL Р С‘Р В·Р С•Р В±РЎР‚Р В°Р В¶Р ВµР Р…Р С‘РЎРЏ (https://...) Р С‘Р В»Р С‘ Р Р†РЎРѓРЎвЂљР В°Р Р†РЎРЉРЎвЂљР Вµ base64"
            defaultEmoji="СЂСџР‹Рѓ"
          />
        </div>
