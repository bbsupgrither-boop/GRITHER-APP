...
export function ShopPageWithTabs({ 
      ...
      {shopItems.length > 0 ? (
        ...
        <div className="glass-card rounded-2xl p-8 text-center apple-shadow">
          ...
          <p className="text-sm text-muted-foreground">
            Р С’Р Т‘Р СР С‘Р Р…Р С‘РЎРѓРЎвЂљРЎР‚Р В°РЎвЂљРїС—Р…РїС—Р…РЎР‚РЎвЂ№ РЎР‚Р В°Р В±Р С•РЎвЂљР В°РЎР‹РЎвЂљ Р Р…Р В°Р Т‘ Р С—Р С•Р С—Р С•Р В»Р Р…Р ВµР Р…Р С‘Р ВµР С Р В°РЎРѓРЎРѓР С•РЎР‚РЎвЂљР С‘Р СР ВµР Р…РЎвЂљР В°
          </p>
        </div>
      )}
    </div>
  ...
  return (
    <div className="min-h-screen bg-background">
      <Header 
        title="Р СљР В°Р С–Р В°Р В·Р С‘Р Р…" 
      ...
      {isCartOpen && (
        <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/50 backdrop-blur-sm">
          <div className="w-full max-w-md bg-background rounded-t-2xl max-h-[75vh] flex flex-col">
            ...
            {/* Р ВРЎвЂљР С•Р С–Р С• Р С‘ Р С”Р Р…Р С•Р С—Р С”Р С‘ - РЎвЂћР С‘Р С”РЎРѓР С‘РЎР‚Р С•Р Р†Р В°Р Р…Р Р…РЎвЂ№Р Вµ Р Р†Р Р…Р С‘Р В·РЎС“ */}
