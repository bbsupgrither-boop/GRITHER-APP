...
export function AdminTasks({ currentAdminPage = 'tasks', setCurrentAdminPage }: AdminTasksProps) {
  ...
  // РџСѓСЃС‚РѕР№ РјР°СЃСЃРёРІ Р°РєС‚РёРІРЅС‹С… Р·Р°РґР°С‡ (Р°РґРјРёРЅРёСЃС‚СЂР°С‚РѕСЂС‹ СЃРѕР·РґР°РґСѓС‚ Р·Р°РґР°С‡Рё СЃР°РјРѕСЃС‚РѕСЏС‚РµР»СЊРЅРѕ)
  const [activeTasks, setActiveTasks] = useState<Task[]>([]);

  // РџСѓСЃС‚РѕР№ РјР°СЃСЃРёРІ РІС‹РїРѕР»РЅРµРЅРЅС‹С… Р·Р°РґР°С‡
              ...
              <div className="space-y-3">
                ...
                {sortedActiveTasks.length === 0 && (
                  <div className="text-center text-muted-foreground py-8">
                    Р—Р°РґР°С‡ РЅР° РїСЂРѕРІРµСЂРєРµ РЅРµС‚
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="p-6">
              {selectedTask && (
                <div className="space-y-4">
                  ...
                  {/* РљРЅРѕРїРєРё РґРµР№СЃС‚РІРёР№ РІРЅРёР·Сѓ (С‚РѕР»СЊРєРѕ РґР»СЏ Р°РєС‚РёРІРЅС‹С… Р·Р°РґР°С‡) */}
