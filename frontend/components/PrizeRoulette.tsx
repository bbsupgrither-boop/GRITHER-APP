...
export function PrizeRoulette({ prizes, onResult, isSpinning, onSpinComplete, hasSpun }: PrizeRouletteProps) {
  ...
  // Р вЂўРЎРѓР В»Р С‘ Р Р…Р ВµРЎвЂљ Р С—РЎР‚Р С‘Р В·Р С•Р Р†, Р Р…Р Вµ РЎР‚Р ВµР Р…Р Т‘Р ВµРЎР‚Р С‘Р С Р С”Р С•Р СР С—Р С•Р Р…Р ВµР Р…РЎвЂљ
  if (!prizes || prizes.length === 0) {
    return (
      <div className="relative w-full h-48 overflow-hidden rounded-xl bg-surface border border-border flex items-center justify-center">
        <div className="text-muted-foreground">Р вЂ”Р В°Р С–РЎР‚РЎС“Р В·Р С”Р В° Р С—РЎР‚Р С‘Р В·Р С•Р Р†...</div>
      </div>
    );
  }
  ...
  // Р В¤РЎС“Р Р…Р С”РЎвЂ Р С‘РЎРЏ Р Т‘Р В»РЎРЏ Р Р†РЎвЂ№Р В±Р С•РЎР‚Р В° Р С—РЎР‚Р С‘Р В·Р В° Р Р…Р В° Р С•РЎРѓР Р…Р С•Р Р†Р Вµ Р Р†Р ВµРЎР‚Р С•РЎРЏРЎвЂљР Р…Р С•РЎРѓРЎвЂљР ВµР в„–
  const selectRandomPrize = (): Prize => {
    ...
    // Р вЂ™Р С•Р В·Р Р†РЎР‚Р В°РЎвЂ°Р В°Р ВµР С Р С—Р С•РЎРѓР В»Р ВµР Т‘Р Р…Р С‘Р в„– Р С—РЎР‚Р С‘Р В· Р С”Р В°Р С” fallback
    return prizes[prizes.length - 1];
  };

  // Р РЋР С•Р В·Р Т‘Р В°Р ВµР С Р В·Р В°РЎвЂ Р С‘Р С”Р В»Р ВµР Р…Р Р…РЎвЂ№Р в„– Р СР В°РЎРѓРЎРѓР С‘Р Р† Р С—РЎР‚Р С‘Р В·Р С•Р Р† Р Т‘Р В»РЎРЏ Р В±Р ВµРЎРѓРЎв‚¬Р С•Р Р†Р Р…Р С•Р в„– Р С—РЎР‚Р С•Р С”РЎР‚РЎС“РЎвЂљР С”Р С‘
  ...
  useEffect(() => {
    if (isSpinning && prizes.length > 0) {
      // Р вЂ™РЎвЂ№Р В±Р С‘РЎР‚Р В°Р ВµР С РЎРѓР В»РЎС“РЎвЂЎР В°Р в„–Р Р…РЎвЂ№Р в„– Р С—РЎР‚Р С‘Р В· Р Р…Р В° Р С•РЎРѓР Р…Р С•Р Р†Р Вµ Р Р†Р ВµРЎР‚Р С•РЎРЏРЎвЂљР Р…Р С•РЎРѓРЎвЂљР ВµР в„–
      const randomPrize = selectRandomPrize();
      setSelectedPrize(randomPrize);
      
      // Р СњР В°РЎвЂ¦Р С•Р Т‘Р С‘Р С Р С—Р С•Р В·Р С‘РЎвЂ Р С‘РЎР‹ Р Р†РЎвЂ№Р В±РЎР‚Р В°Р Р…Р Р…Р С•Р С–Р С• Р С—РЎР‚Р С‘Р В·Р В° Р Р† РЎРѓРЎР‚Р ВµР Т‘Р Р…Р ВµР в„– РЎвЂЎР В°РЎРѓРЎвЂљР С‘ Р С—Р С•Р Р†РЎвЂљР С•РЎР‚РЎРЏРЎР‹РЎвЂ°Р ВµР С–Р С•РЎРѓРЎРЏ Р СР В°РЎРѓРЎРѓР С‘Р Р†Р В°
      ...
      // Р В Р В°РЎРѓРЎРѓРЎвЂЎР С‘РЎвЂљРЎвЂ№Р Р†Р В°Р ВµР С РЎвЂћР С‘Р Р…Р В°Р В»РЎРЉР Р…РЎвЂ№Р в„– offset РЎвЂЎРЎвЂљР С•Р В±РЎвЂ№ Р Р†РЎвЂ№Р В±РЎР‚Р В°Р Р…Р Р…РЎвЂ№Р в„– Р С—РЎР‚Р С‘Р В· Р С•Р С”Р В°Р В·Р В°Р В»РЎРѓРЎРЏ Р Р† РЎвЂ Р ВµР Р…РЎвЂљРЎР‚Р Вµ
